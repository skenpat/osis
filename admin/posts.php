        ...
        <div class="content-area">
            ...
            <div class="table-card">
                <div class="table-header">
                    <h3 class="table-title">Semua Artikel</h3>
                            ...
                            <tbody>
                                <?php $i = $offset + 1; while ($post = mysqli_fetch_assoc($result)): ?>
                                    <tr>
                                        <td><?php echo $i++; ?></td>
                                        <td>
                                            <img src="admin/uploads/<?php echo $post['image']; ?>" class="img-fluid rounded" alt="<?php echo $post['title']; ?>" width="60">
                                        </td>
                                        <td>
                                            <div class="post-title"><?php echo $post['title']; ?></div>
                                            <div class="post-meta">
                                                <span><i class="bi bi-calendar3"></i> <?php echo format_date($post['created_at']); ?></span>
                                                <span><i class="bi bi-person"></i> <?php echo $post['author']; ?></span>
                                            </div>
                                        </td>
                                        <td><?php echo format_date($post['created_at']); ?></td>
                                        <td>
                                            <span class="status-badge status-<?php echo ($post['status'] == 'published') ? 'published' : 'draft'; ?>">
                                                <?php echo ($post['status'] == 'published') ? 'Diterbitkan' : 'Draft'; ?>
                                            </span>
                                        </td>
                                        <td>
                                            <div class="action-buttons">
                                                ...
                                                <a href="posts.php?action=delete&id=<?php echo $post['id']; ?>" class="btn-action btn-delete" title="Hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus artikel ini?')">
