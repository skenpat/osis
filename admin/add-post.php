        ...
        <div class="content-area">
            <div class="form-card">
                <div class="form-header">
                    <h2 class="form-title">Informasi Artikel</h2>
                ...
                <form action="add-post.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="text-editor">
                            ...
                            <div class="editor-content" contenteditable="true" id="content" name="content"></div>
                        </div>
                        <div class="char-counter">
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-upload">
                            ...
                            <div class="upload-text">Klik untuk mengunggah gambar</div>
                            <div class="upload-hint">Format yang diperbolehkan: JPEG, JPG, PNG, GIF</div>
